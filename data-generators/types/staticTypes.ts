export type CrvsDate = `${number}-${number}-${number}`

export type Uuid = string

export type AdminStructure = Uuid

export type Facility = Uuid
...
export const COUNTRIES = [
  ...
  'EST', 'ETH', 'FAR', 'FIN', 'FJI', 'FLK', 'FRA', 'FRO', 'FSM', 'GAB',
  ...
  'KHM', 'KIR', 'KNA', 'KOR', 'KWT', 'LBN', 'LBR', 'LBY', 'LCA', 'LIE',
  ...
  'TKL', 'TKM', 'TLS', 'TON', 'TTO', 'TUN', 'TUR', 'TUV', 'TZA', 'UGA',
